    ...
    return (
      <>
        ...
        <LeftSection
          ...
          learnMore="/equinox-trade"
        />
        <p className="text-center mt-5 mb-5 fs-2" style={{ color: "#c8cbd4" }}>
          Explore the technology and engineering behind our platform,
          <a href="" style={{ textDecoration: "none", color: "#7C8CFF" }}>
            {" "}
