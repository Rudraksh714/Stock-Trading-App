  ...
  return (
    <div className="container">
      <div className="text-center mb-5">
        <h2 className="fw-semibold fs-1 mb-2">Pricing & Fees</h2>
                  ...
                  <div className="accordion-body">
                    <div className="d-flex justify-content-between mb-3">
                      <div>
                        ...
                        <p className="text-muted mb-0">₹0 brokerage</p>
                      </div>
                      <div className="text-end">
                        <strong>Intraday</strong>
                        <p className="text-muted mb-0">Up to ₹20 per order</p>
                      </div>
                    </div>
                  ...
                  <div className="accordion-body">
                    <div className="d-flex justify-content-between mb-3">
                      ...
                      <div className="text-end">
                        ...
                        <p className="text-muted mb-0">Competitive brokerage</p>
                      </div>
                    </div>
                  ...
                  <div className="accordion-body">
                    <div className="d-flex justify-content-between mb-3">
                      <div>
                        ...
                        <p className="text-muted mb-0">₹0 commission</p>
                      </div>
                      <div className="text-end">
                  ...
                  <div className="accordion-body">
                    <div className="d-flex justify-content-between mb-3">
                      <div>
                        ...
                        <p className="text-muted mb-0">Transparent pricing</p>
                      </div>
                      <div className="text-end">
                        <strong>Government Bonds</strong>
                        <p className="text-muted mb-0">Easy access</p>
                      </div>
                    </div>
                  ...
                  <div className="accordion-body">
                    <div className="d-flex justify-content-between mb-3">
                      ...
                      <div className="text-end">
                        ...
                        <p className="text-muted mb-0">As applicable</p>
                      </div>
                    </div>
                  ...
                  <div className="accordion-body">
                    <div className="d-flex justify-content-between mb-3">
                      <div>
                        ...
                        <p className="text-muted mb-0">Transparent charges</p>
                      </div>
                      <div className="text-end">
